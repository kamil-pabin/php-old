...
<head>
  ...
  <link rel="stylesheet" type="text/css"
    href="https://cdn.datatables.net/v/bs4/jq-3.3.1/dt-1.10.18/b-1.5.6/b-print-1.5.6/fh-3.1.4/r-2.2.2/datatables.min.css" />
...
<body>
  <div class="table-responsive table-dark">
    <div align="right">
      <form>
        <input type="button" value="Wszystkie" class="btn btn-success disabled aria-pressed='true' " " />
        <input type="button" value="Sprzedane" class="btn btn-primary" onclick="window.location.href='sprzedane.php'" />
        <input type="button" value="Niesprzedane" class="btn btn-primary" onclick="window.location.href='niesprzedane.php'" />
      </form>
    </div>
...
<script type="text/javascript" language="javascript">
  $(document).ready(function () {
    ...
    $(document).on('click', '#insert', function () {
      ...
      var sprzedane = $('#data5').text();
      if (ip != '' && email != '' && pass != '' && sessionid != '' && sprzedane != '') {
        $.ajax({
          url: "insert.php",
          method: "POST",
          data: {
    ...
    $(document).on('click', '.odsprzedaj', function () {
