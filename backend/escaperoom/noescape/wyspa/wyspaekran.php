<html>
<!-- Strona służąca do wyświetlania informacji w pokoju wyspa -->
<head>
    <title>Wyspa pokoj</title>
    <meta charset="utf-8">
    ...
    <style>
        body {
            margin: 0;
            padding: 0;
            background-image: radial-gradient(farthest-side at 30% 30%,#b59228,#28b52f);
    ...
    <script type="text/javascript">
        ...
        function fu() {
            ...
            xmlhttp.open("GET", "getdatawyspa.php?q=" + '1', true);
            xmlhttp.send();
        }
        function zegarek(str){
            ...
            if (str == "") {
                ...
                xmlhttp.open("GET", "timerwyspa.php", true);
                xmlhttp.send();
            }
        }
    </script>
...
<body>
    ...
    <div id="mainscreen"  style="height:6000px;">
        <div class="row">           
            <div class="col">
                <div class='xd'>
                    <center>
