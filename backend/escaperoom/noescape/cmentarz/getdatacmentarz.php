...
<body>
    <?php
        ...
        $sql="SELECT * FROM cmentarz WHERE cmentarz.ID = '".$q."' ";       
        ...
        while($row = mysqli_fetch_array($result)) 
        {
            ...
            else if ($dlugosc >= 60 AND $dlugosc < 120){
                $fontsize = "4vw";
            }
            else if ($dlugosc >= 120 AND $dlugosc < 220){
                $fontsize = "3.5vw";
            }
            else if ($dlugosc >= 220){
                $fontsize = "2.5vw";
            }
            echo "<img src='" .$row['Zdjecie']."' style='width: 1280px; max-height:600px'  >" . "</br>";  
